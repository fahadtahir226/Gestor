          ...
          <div className="col s12 m12 l12">
            <div className="container-fluid">
              ...
              <div className="col s12 m6 ">
                <h5 style={{textAlign: "left"}}>Regístrate </h5>
                ...
                <div style={styleBox.inputNamContainerf}>
                    ...
                    <input id='reg-fname' placeholder='Nombre' style={styleBox.inputsNam} type="email" />
                </div>
                </div>
                {/* Last Name */}
                ...
                <div style={styleBox.inputNamContainerl}>
                    ...
                    <input id='reg-lname' placeholder='Apellido(s)' style={styleBox.inputsNam} type="email" />
                </div>
                </div>
                 {/* EMAIL */}
                <div className="col s12 m12 l12" style={{ width: "98%", marginLeft: 7, textAlign: "left", height: 45, background: '#F2F0EC', border: "0px solid ", borderRadius: 10 }}>
                    ...
                    <input id='reg-email' placeholder='Correo electrónico' style={styleBox.inputs} type="email" />
                </div>
                {/* Password */}
                <div className="col s12 m12 l12" style={{width: "98%", marginLeft: 7, marginRight: 5, textAlign: "left", marginTop: 10,height: 45, background: '#F2F0EC', border: "0px solid ", borderRadius: 10 }}>
                    ...
                    <input id='reg-password' placeholder='Contraseña ' style={styleBox.inputs} type="Password" />
                </div>

                <a href="#!" class="col s12 m12 l12 waves-effect waves-light blue darken-1 btn-small" onClick={()=>SignUpCall()} style={styleBox.loginBtn}>Regístrate</a>
                </div>
                ...
                <p style={{color: "grey", marginTop: 10}}>ya miembro? <Link to="/es/"><b>Inicia sesión aquí</b></Link> </p>
              </div>
            </div>
            </div>
          </div>

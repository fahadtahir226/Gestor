    ...
    <div className="container-fluid card z-depth-1" style={styleBox.main}>
      ...
      <div className="row">
        <div className="col s12 m12 l6" >
          <Expandable heading="Plan Básico" questions={data.BasicPlan}/>
          <Expandable heading="Impuestos" questions={data.Taxes} />
          <Expandable heading="Cambio de plan" questions={data.ChangePlan} />
          <Expandable heading="Suscripción" questions={data.Subscriptions} />
        </div>
        <div className="col s12 m12 l6" >
          <Expandable heading="PRO PLANS" questions={data.ProPlan} />
          <Expandable heading="Seguridad" questions={data.Security} />
          <Expandable heading="Mi perfil" questions={data.MyProfile} />
          <Expandable heading="Mi cuenta" questions={data.MyAccount} />
        </div>
      </div>
    </div>
    )

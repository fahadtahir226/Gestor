...
const Pdf = (props) => {
  // console.log(props.data.numbersList);
    return (
        <li>
          <div className="collapsible-header modal-trigger" href="#docPdf" style={{paddingTop: '0px !important', paddingBottom: '0px !important'}} onClick={()=> window.open(props.path, "_blank")}>
